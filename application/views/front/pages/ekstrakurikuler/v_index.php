          ...
          <div class="card h-100 border rounded-4 shadow-sm hover-card d-flex flex-column">
            ...
            <?php
              $thumb = !empty($k->foto_terbaru) 
                       ? base_url('uploads/ekstrakurikuler/'.$k->foto_terbaru)
            ...
            <div class="card-body text-center d-flex flex-column px-3">
              <h6 class="card-title fw-semibold mb-2"><?= htmlspecialchars($k->nama_kategori); ?></h6>
            ...
            <div class="card-footer bg-transparent border-0 text-center pb-3">
              <a href="<?= site_url('akademik/ekskul_detail/'.$k->id); ?>"
